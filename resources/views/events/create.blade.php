        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{url('/event/save')}}" class="form-horizontal" method="post" onsubmit="return confirm('Are you sure want to save?')">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control" value="{{old('event_date')}}" name="event_date" id="event_date">
                                    </div>
                                </div>
                                <div class="form-group row">
