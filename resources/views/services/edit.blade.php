        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{url('/service/update')}}" class="form-horizontal" method="post" onsubmit="return confirm('Are you sure want to change?')">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$service_list->servicesname}}" name="name" id="name" required="true">
                                        <input type="hidden" name="id" value="{{$service_list->id}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="category" id="category" class="form-control" required="true">
                                            @foreach($categories as $cate)
                                                <?php
                                                    if($cate->id==$service_list->category_id){
                                                        $selected ="selected";
                                                    }else{
                                                        $selected="";
                                                    }
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" value="{{$service_list->price}}" name="price" id="price" required="true" step=".001">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="name" class="control-label col-sm-3 lb">Description</label>
                                    <div class="col-sm-8">
                                        <textarea id="description" name="description" class="form-control">{{$service_list->description}}</textarea>
                                         <p>
                                            <br>
