        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{url('/salesperson/create')}}" class="text-info"><i class="fa fa-plus"></i> New</a>
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{url('/salesperson/update')}}" class="form-horizontal" method="post" onsubmit="return confirm('Are you sure want to save changes?')">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$salesperson->first_name}}" name="first_name" id="first_name" required>
                                    </div>
                                </div>
                               ...
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$salesperson->last_name}}" name="last_name" id="last_name" required>
                                    </div>
                                </div>
                                 <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$salesperson->dob}}" name="dob" id="dob">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email" class="control-label col-sm-3 lb">Email</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$salesperson->email}}" name="email" id="email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="phone" class="control-label col-sm-3 lb">Phone</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$salesperson->phone}}" name="phone" id="phone">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        @foreach($branches as $branch)
                                            <option value="{{$branch->id}}" {{$salesperson->branch_id==$branch->id?'selected':''}}>{{$branch->name}}</option>
                                        @endforeach
                                        </select>
                                         <p>
                                            <br>
